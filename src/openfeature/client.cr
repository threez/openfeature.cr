...
module OpenFeature
  ...
  class Client
    ...
    def boolean_value(flag_key : String,
      ...
      boolean_details(flag_key, default, context: ctx, options: options).value
    end
    ...
    def string_value(flag_key : String,
      ...
      string_details(flag_key, default, context: ctx, options: options).value
    end
    ...
    def number_value(flag_key : String,
      ...
      number_details(flag_key, default, context: ctx, options: options).value
    end
    ...
    def object_value(flag_key : String,
      ...
      object_details(flag_key, default, context: ctx, options: options).value
    end
    ...
    def boolean_details(flag_key : String,
      ...
      FlagEvaluationDetails(Bool).new(flag_key, Type::Boolean, details)
    end
    ...
    def string_details(flag_key : String,
      ...
      FlagEvaluationDetails(String).new(flag_key, Type::String, details)
    end
    ...
    def number_details(flag_key : String,
      ...
      FlagEvaluationDetails(Number).new(flag_key, Type::Number, details)
    end
